  ...
  <body>
    ...
    <div  style="background: #2d3693" class="header-area" id="headerArea">
      <div   class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
        <!-- Back Button-->
        <div class="back-button me-2"><a href="cart.html"><i style="color: white" class="fa-solid fa-arrow-left-long"></i></a></div>
        <!-- Page Title-->
        <div class="page-heading">
          <h6 style="color: white" class="mb-0">Billing Information</h6>
        </div>
        <!-- Navbar Toggler-->
      ...
      <div class="container">
        ...
        <div class="checkout-wrapper-area py-3">
          ...
          <div class="billing-information-card mb-3">
            <div style="background: #2d3693" class="card billing-information-title-card">
              <div class="card-body">
              ...
              <div class="card-body">                                   
                ...
                <div class="single-profile-data d-flex align-items-center justify-content-between">
                  ...
                  <div class="data-content">
                    <input type="number" id="tell" placeholder="Fadlan gali telka" class="form-control" name=""></div>
                    
                </div>
                <div class="single-profile-data d-flex align-items-center justify-content-between">
                  <div class="title d-flex align-items-center"><i class="fa-solid fa-location-crosshairs"></i><span>Address</span></div>
                  <div class="data-content">
                    <input type="text" id="address" class="form-control" placeholder="Fadlan Gali Gobta" name=""></div>
                </div>
               
               <input type="hidden" id="item_id" placeholder="Fadlan gali telka" class="form-control" value="<?php echo $_GET['item_id'] ?>">
                    <input type="hidden" id="price"  value="<?php echo $_GET['price'] ?>" placeholder="Fadlan gali telka" class="form-control" name="">

                    <input type="text" class="item"  value="<?php echo $_GET['name'] ?>" placeholder="Fadlan gali telka" class="form-control" name="">
              </div>
            </div>
          </div>
          ...
          <div class="card cart-amount-area">
            <div class="card-body d-flex align-items-center justify-content-between">
              <h5 class="total-price mb-0">$<span class="counter"><?php echo $_GET['price'] ?></span></h5>
              <a class="btn btn-warning paynow" href="#">Pay Now</a>
            </div>
          </div>
        </div>
      </div>
