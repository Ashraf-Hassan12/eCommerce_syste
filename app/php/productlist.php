   ...
   <div class="top-products-area py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between dir-rtl">
            <h6><?php echo $_GET['category'] ?></h6><a class="btn p-0" href="shop-grid.html">View All<i class="ms-1 fa-solid fa-arrow-right-long"></i></a>
          </div>
          <div class="row g-2">
            <!-- Product Card -->
<?php 
...
extract($_GET);
$sql = "call show_alll_products_sp($id)";
$ress = $conn->query($sql);
           ...
           <div class="col-6 col-md-4">
              <div class="card product-card">
                <div class="card-body">
                  ...
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="single-product.html">
                  ...
                  <!-- Product Title --><a class="product-title" href="single-product.html"><?php echo $row['name'] ?></a>
                  <!-- Product Price -->
                  ...
                  <!-- Add to Cart -->
                  <a class="btn btn-success btn-sm" href="#"><i class="fa-solid fa-cart-shopping"></i></a>
                </div>
              </div>
            </div>
  <?php 
