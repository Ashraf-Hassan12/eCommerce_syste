...
<html lang="en">
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-4 pb-4 text-center bg-primary">
                                <a href="index.php">
                                    <h2 style="color:white"><?php echo $company ?></h2>
                                </a>
                            </div>
 ...
 <form action="tools/check_login.php" method="post">
<div class="mb-3">
 ...
 <center style="color: red;"><?php echo @$_GET['error'] ?></center>
            ...
            2023 © <?php echo $company ?> Powered by <a target="_blank" href="https://wa.me/2526162626">612526226</a>
        </footer>
                            </div> <!-- end card-body -->
                        </div>
